...
<head>
	<title>other_institute_student</title>
</head>
...
<body>
	<center>
		...
		// Taking all 11 values from the form data(input)
		...
		$sql = "INSERT INTO other_institute_student VALUES ('$enter_name','$enter_institute_name','$enter_AISHE_code','$program','$select_year','$select_semester','$enter_course','$email_id','$mobile_number','$enter_address','$DOB')";
