...
<body>
  ...
  <nav>
    ...
    <li><a href="index.html" style="float: left">Home</a></li>
      ...
      <li><select class="n_panel" id="cars" name="program" style="float:left" size="1" onchange="window.location.href=this.value;" required>
          ...
          <option value="reg_school_teacher.html" class="input-box"><a href="reg_school_teacher.html">School
              Teachers</a></option>
          <option value="reg_other_institute_faculty.html" class="input-box"><a href="reg_other_institute_faculty.html">Other Institute Faculty</a></option>
      ...
      <li><select class="n_panel" size="1" onchange="window.location.href=this.value;" style="float:right" name="login" id="---" required>
          ...
          <option value="login_coordinator.php" class="input-box"><a href="reg_entrepreneur_startup.html">Co-ordinator</a></option>
        </select></li>
